...
We will also work on using the time we do have together as effectively as possible by identifying things we can work on independently and managing merge conflicts. Outside of time together we will attempt to complete as much as we can on independent pieces of the project to make time together as productive as possible.
